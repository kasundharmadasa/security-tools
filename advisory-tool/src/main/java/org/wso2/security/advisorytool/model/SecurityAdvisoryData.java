...
/**
 * YAML class to load security-advisory-data.yaml.
 */
public class SecurityAdvisoryData {
    ...
    public SecurityAdvisoryData(String title, String date, String overview, String description,
                                String impact, String solution, String notes, String credits,
                                String publicDisclosure, String severity, String score, String thanks,
